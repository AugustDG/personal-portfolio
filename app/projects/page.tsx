    ...
    <div className="space-y-14 animate-fadeIn">
      <section>
        <h1 className="font-pixel text-3xl mb-8 font-semibold tracking-tight">
          ...
          <span className="block h-1 mt-4 w-64 bg-gradient-to-r from-retro-magenta via-retro-purple/60 to-transparent" />
        </h1>
        <h2 className="font-pixel text-2xl mb-6 flex items-center gap-3">
          ...
          <span className="flex-1 h-[2px] bg-gradient-to-r from-retro-yellow via-retro-magenta to-transparent" />
        </h2>
      ...
      <section className="space-y-6">
        <h2 className="font-pixel text-2xl flex items-center gap-3">
          ...
          <span className="flex-1 h-[2px] bg-gradient-to-r from-retro-teal via-retro-cyan to-transparent" />
        </h2>
